...
function clean_journal_enqueue_metabox_scripts() {
    //Scripts
	wp_enqueue_script( 'clean-journalmetabox', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/clean-journal-metabox.min.js', array( 'jquery', 'jquery-ui-tabs' ), '2013-10-05' );

	//CSS Styles
	wp_enqueue_style( 'clean-journalmetabox-tabs', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/clean-journal-metabox-tabs.css' );
}
